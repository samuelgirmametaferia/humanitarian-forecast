...
from location_model import ProbabilisticLocationTransformer, gaussian_location_loss
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", type=Path, default=Path("checkpoints_location"))
