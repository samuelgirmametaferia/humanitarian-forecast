...
from humanitarian_forecast.location.models.geo_fusion import spatial_distribution_loss
from humanitarian_forecast.location.models.geo_fusion_v2 import GeoFusionCandidateRankerV2
...
def collect(
    model: GeoFusionCandidateRankerV2,
    loader: DataLoader,
    device: torch.device,
...
def main() -> None:
    ...
    parser.add_argument("--soft50-weight", type=float, default=0.20)
    parser.add_argument("--soft100-weight", type=float, default=0.10)
    parser.add_argument("--distance-weight", type=float, default=0.75)
    parser.add_argument("--displacement-weight", type=float, default=0.05)
    ...
    checkpoint = {
        "model_type": "GeoFusionCandidateRankerV2",
    ...
    write_info(
        ...
        ModelInfo(
            ...
            description=(
                "Sharper motion-aware GeoFusion V2 broad-area ranker with latest-state pooling, "
