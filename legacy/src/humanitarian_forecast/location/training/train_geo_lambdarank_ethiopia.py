#!/usr/bin/env python3
"""Train an Ethiopia-specialized broad-area LambdaRank expert with global replay.
...
def main() -> None:
    ...
    config = {
        ...
        "feature_dim": int(candidates.shape[-1] + 12 + 4 + 68),
    ...
    write_info(
        args.output_dir,
        ModelInfo(
            subsystem="location/geo_lambdarank_ethiopia",
            version=args.version,
            status="research-challenger",
            description="Ethiopia-specialized LambdaRank expert with global replay, regional weighting, full-history summaries, and motion geometry.",
